...
<style>
        /* Ini adalah CSS yang mengatur latar belakang menjadi warna hitam */
        body {
            background-color: orange;
            color: white; /* Mengatur warna teks menjadi putih agar terlihat dengan baik di latar belakang hitam */
        }
    </style>
